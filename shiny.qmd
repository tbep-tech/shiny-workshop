...
If you did not already have the `shiny` package installed, you should restar RStudio to use additional menu items for the next step.
...
Let's add dropdown menus for station and parameter selection and placeholders for `plotly` and `leaflet` outputs. These outputs are **htmlwidgets ** you learned about in the morning (see [Quarto using htmlwidgets](https://tbep-tech.github.io/shiny-workshop/quarto.html#quarto-using-htmlwidgets)), except we will be udpating them _interactively_ based on user intput.
