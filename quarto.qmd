...
Observable is a relatively new language that also allows dynamic features in a Quarto document.  It is an entirely separate language outside of R, but provides even more functionality that approximates a Shiny Server.  
