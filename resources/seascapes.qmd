...
image: "../figs/resources/seascapes-for-sanctuaries.png"
format: 
  html: 
    toc: true
categories: 
...
The [app's source code](https://github.com/noaa-onms/seascapes-app/tree/main/app) makes use of custom data wrangling and visualization functions in the R package [seascapeR](https://marinebon.github.io/seascapeR/).
